...
export const data = new SlashCommandBuilder()
  .setName("leaderboard")
  .setDescription("View leaderboards for coins, battle stats, items, and more");
...
export async function execute(interaction: ChatInputCommandInteraction) {
  ...
  const sent = await interaction.reply({ embeds: [welcomeEmbed], components: buildCategoryRows(), fetchReply: true });
